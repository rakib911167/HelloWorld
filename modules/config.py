...
def try_load_deprecated_user_path_config():
    ...
    try:
        ...
        if deprecated_config_dict.get("default_model", None) == 'Rakibuniverse.V2.safetensors':
...
default_base_model_name = get_config_item_or_set_default(
    key='default_model',
    default_value='Rakibuniverse.V2.safetensors',
...
checkpoint_downloads = get_config_item_or_set_default(
    ...
    default_value={
        "Rakibuniverse.V2.safetensors": "https://huggingface.co/rafiislam/RakibUniverse/resolve/main/Rakibuniverse.V2.safetensors?download=true"
    },
